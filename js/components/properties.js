// var hexaColor = new RegExp("/(#*([a-fA-F0-9]{6}))/","g");

var colorsFull = {
	"red" : new String("#ffebee red lighten-5,#ffcdd2 red lighten-4,#ef9a9a red lighten-3,#e57373 red lighten-2,#ef5350 red lighten-1,#f44336 red,#e53935 red darken-1,#d32f2f red darken-2,#c62828 red darken-3,#b71c1c red darken-4,#ff8a80 red accent-1,#ff5252 red accent-2,#ff1744 red accent-3,#d50000 red accent-4"), 
	...
	"brown" : new String("#efebe9 brown lighten-5,#d7ccc8 brown lighten-4,#bcaaa4 brown lighten-3,#a1887f brown lighten-2,#8d6e63 brown lighten-1,#795548 brown,#6d4c41 brown darken-1,#5d4037 brown darken-2,#4e342e brown darken-3,#3e2723 brown darken-4"),
	"grey" : new String("#fafafa grey lighten-5,#f5f5f5 grey lighten-4,#eeeeee grey lighten-3,#e0e0e0 grey lighten-2,#bdbdbd grey lighten-1,#9e9e9e grey,#757575 grey darken-1,#616161 grey darken-2,#424242 grey darken-3,#212121 grey darken-4"),
	"blueGrey" : new String("#eceff1 blue-grey lighten-5,#cfd8dc blue-grey lighten-4,#b0bec5 blue-grey lighten-3,#90a4ae blue-grey lighten-2,#78909c blue-grey lighten-1,#607d8b blue-grey,#546e7a blue-grey darken-1,#455a64 blue-grey darken-2,#37474f blue-grey darken-3,#263238 blue-grey darken-4"),
	"bwt" : new String("#000000 black,#ffffff white,transparent")			
};

var colors = {
	"red" : colorsFull.red.split(','),
	"pink" : colorsFull.pink.split(','),
	"purple" : colorsFull.purple.split(','),
	"deepPurple" : colorsFull.deepPurple.split(','),
	"indigo" : colorsFull.indigo.split(','),
	"blue" : colorsFull.blue.split(','),
	"lightBlue" : colorsFull.lightBlue.split(','),
	"cyan" : colorsFull.cyan.split(','),
	"teal" : colorsFull.teal.split(','),
	"green" : colorsFull.green.split(','),
	"lightGreen" : colorsFull.lightGreen.split(','),
	"lime" : colorsFull.lime.split(','),
	"yellow" : colorsFull.yellow.split(','),
	"amber" : colorsFull.amber.split(','),
	"orange" : colorsFull.orange.split(','),
	"deepOrange" : colorsFull.deepOrange.split(','),
	"brown" : colorsFull.brown.split(','),
	"grey" : colorsFull.grey.split(','),
	"blueGrey" : colorsFull.blueGrey.split(','),
	"bwt" : colorsFull	.bwt.split(',')
};